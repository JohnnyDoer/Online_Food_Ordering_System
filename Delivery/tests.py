...
class DeliveryPageTests(TestCase):
    ...
    def test_delivery_signup(self):
        c = Client()
        response = c.post('/delivery/signup/', {'username': 'save12', 'email': 'eede@gmail.com', 'password': 'asdfghjkl12'})
        self.assertEquals(response.status_code,200)
...
class SimpleTest(unittest.TestCase):
    def setUp(self):
        ...
        self.createadmin = User.objects.create(username="qwerefty", email="test@gmil.com", password="asdfefghjkl")
        self.client = None
