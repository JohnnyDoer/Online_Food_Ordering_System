    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Restaurant_Area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Restaurants.Area')),
                ('Restaurant_City', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Restaurants.City')),
